...
// Enter your solution code here:
commentById = comments.find((object)=> {
    return (object.id)===823423
})
...
idx = comments.findIndex((object)=> {
    return (object.id)===123523
})
...
totalYearsLived = inventors.reduce((total,inventor)=> {
    const lifespawn = inventor.passed - inventor.year;
    return total + lifespawn
}, 0);
